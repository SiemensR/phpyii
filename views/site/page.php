...
<div class="site-index">
        ...
        <div class="nav-container" style="min-height: 64px;">
            <div class="bg-dark navbar-dark position-fixed" data-sticky="top" style="max-width: 1903px; top: 0px;">
                <div class="container">
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarNav">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="documentation/changelog.html" class="nav-link">Changelog <span class="badge badge-secondary mr-2">v1.0.3</span></a>
                                </li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="main-carousel overflow-visible flickity-enabled" data-flickity="{ &quot;cellAlign&quot;: &quot;center&quot;, &quot;contain&quot;: true, &quot;prevNextButtons&quot;: false, &quot;pageDots&quot;:true, &quot;wrapAround&quot;:true, &quot;autoPlay&quot;:5000, &quot;imagesLoaded&quot;:true, &quot;initialIndex&quot;:3, &quot;draggable&quot;:false }" tabindex="0">
                            ...
                            <div class="flickity-viewport" style="height: 549.5px;"><div class="flickity-slider" style="left: 0px; transform: translateX(-179.17%);"><div class="carousel-cell col-11" style="position: absolute; left: 0%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="landing-1.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div><div class="carousel-cell col-11" style="position: absolute; left: 91.67%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="landing-2.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div><div class="carousel-cell col-11 is-selected" style="position: absolute; left: 183.33%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="landing-8.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div><div class="carousel-cell col-11" style="position: absolute; left: 275%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="landing-9.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div><div class="carousel-cell col-11" style="position: absolute; left: 366.67%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="app-collection-list.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div><div class="carousel-cell col-11" style="position: absolute; left: 458.33%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="app-docs-landing.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div><div class="carousel-cell col-11" style="position: absolute; left: 550%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="app-discussion-list.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div><div class="carousel-cell col-11" style="position: absolute; left: 641.67%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="app-profile-social.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div><div class="carousel-cell col-11" style="position: absolute; left: 733.33%;">
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <a target="_blank" href="app-project-detail.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="Open in new tab"><i class="icon-popup"></i></a>
                                        </div>
                                    </div>
                                </div></div></div><ol class="flickity-page-dots"><li class="dot"></li><li class="dot"></li><li class="dot is-selected"></li><li class="dot"></li><li class="dot"></li><li class="dot"></li><li class="dot"></li><li class="dot"></li><li class="dot"></li></ol></div>
                        </div>
                        <!--end of col-->
                    </div>
                    <!--end of row-->
                ...
                <div class="container">
                    ...
                    <ul class="row feature-list feature-list-sm">
                        <li class="col-12 col-md-4">
                            ...
                            <a href="pages-landing.html">Explore Landing Pages ›</a>
                        </li>
                        <!--end of col-->
                        <li class="col-12 col-md-4">
                            ...
                            <a href="pages-app.html">Explore App Pages ›</a>
                        </li>
                        <!--end of col-->
                        <li class="col-12 col-md-4">
                            ...
                            <a href="pages-inner.html">Explore Inner Pages ›</a>
                        </li>
                        <!--end of col-->
                    </ul>
                    <!--end of row-->
                ...
                <div class="container">
                    <div class="row justify-content-around align-items-center">
                        ...
                        <div class="col-8 col-md-6 col-lg-4">
                            <img alt="Image" src="assets/img/graphic-developer-group.svg" class="img-fluid box-shadow">
                        </div>
                        <!--end of col-->
                    </div>
                    <!--end of row-->
                    ...
                    <div class="row justify-content-around align-items-center">
                        ...
                        <div class="col-12 col-md-5 order-md-1">
                            <a href="pages-app.html">
                                <img alt="Image" src="assets/img/graphic-intro-ipad.png" class="img-fluid box-shadow">
                            </a>
                        </div>
                        <!--end of col-->
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-around align-items-center">
                        <div class="col-12 col-md-6 col-lg-5 order-md-2">
                            <ul class="nav" id="myTab" role="tablist">
                                <li>
                                    <div class="active card" id="tab-1" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                                        <div class="card-body">
                                ...
                                <li>
                                    <div class="card" id="tab-2" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">
                                        <div class="card-body">
                                ...
                                <li>
                                    <div class="card" id="tab-3" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">
                                        <div class="card-body">
                        ...
                        <div class="col-12 col-md-6 order-md-1">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="tab-1">
                                    <img alt="Image" class="img-fluid box-shadow" src="assets/img/graphic-intro-widgets.png">
                                </div>
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="tab-2">
                                    <img alt="Image" class="img-fluid box-shadow" src="assets/img/graphic-intro-code.png">
                                </div>
                                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="tab-3">
                                    <img alt="Image" class="img-fluid box-shadow" src="assets/img/graphic-intro-plugins.png">
                                </div>
                            </div>
                        </div>
                        <!--end of col-->
                    ...
                    <div class="row justify-content-center text-center section-outro">
                        <div class="col-lg-4 col-md-5">
                            ...
                            <a href="components-bootstrap.html">Start exploring ›</a>
                        </div>
                        <!--end of col-->
                    </div>
                    <!--end of row-->
